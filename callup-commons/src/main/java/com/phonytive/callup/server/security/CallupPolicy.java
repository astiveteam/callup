...
import com.phonytive.callup.server.ServiceProperties;
 ...
 * @since 1.0.0
 */
public class CallupPolicy extends Policy {
  private static PermissionCollection perms;
  private static final CallupPolicy INSTANCE = new CallupPolicy();
   ...
   * @return the only instance of AstPolicy.
   */
  public static CallupPolicy getInstance() {
    return INSTANCE;
  }
